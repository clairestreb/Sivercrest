...
$(function () {
    $.ajax({
        ...
        url: '/Client/Holdings/GetChartAssetClass',
        data: {
        ...
        success: function (chartsdata) {
            ...
            function drawChart() {
                ...
                for (var i = 0; i < chartsdata.length; i++) {
                    ...
                    data.addRow([legendName, chartsdata[i].Percent, tooltipArguments]);
                }
                ...
                var options = {
                    ...
                    pieSliceText: 'none',
                    slices: {},
                    chartArea: { width: '70%', height: '70%', top: '20', bottom: '15' },
                    legend: 'none',
                    titlePosition: 'none',
                ...
                for (var i = 0; i < data.getNumberOfRows() ; i++) {
                    ...
                    var value = Math.round(data.getValue(i, 1) * 10000) / 100;
