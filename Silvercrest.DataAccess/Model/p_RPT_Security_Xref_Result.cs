...
namespace Silvercrest.DataAccess.Model
{
    ...
    public partial class p_RPT_Security_Xref_Result
    {
        public Nullable<int> total_mv { get; set; }
        public Nullable<int> pct_portfolio { get; set; }
        public Nullable<int> pct_asset_class { get; set; }
